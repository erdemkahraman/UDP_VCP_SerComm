...
float i;
float j;
uint8_t udp_data[5004] = {0};
uint8_t str1[342] = {0};
uint8_t sendBuf[342] = {0};
extern UART_HandleTypeDef huart6;
/* Private typedef -----------------------------------------------------------*/
/* Private define ------------------------------------------------------------*/
#define UDP_SERVER_PORT    5004   /* define the UDP local connection port */
#define UDP_CLIENT_PORT    5004   /* define the UDP remote connection port */
